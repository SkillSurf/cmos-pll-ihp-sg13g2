...
N -10 120 10 120 {lab=GND}
N -390 120 -320 120 {lab=GND}
N 10 50 10 120 {lab=GND}
N -320 120 -10 120 {lab=GND}
C {vsource.sym} -580 70 0 0 {name=VPB value=1.2 savecurrent=false}
...
"}
C {devices/code_shown.sym} 60 -320 0 0 {name=NGSPICE only_toplevel=true 
value="
.param temp=27
.control
dc Ven 0 1.2 0.1
...
C {devices/code_shown.sym} -480 -310 0 0 {name=MODEL2 only_toplevel=true
format="tcleval( @value )"
value="
