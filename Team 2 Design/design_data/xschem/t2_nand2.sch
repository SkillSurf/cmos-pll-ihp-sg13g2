...
N 160 60 160 160 {lab=GND}
N 60 190 60 220 {lab=GND}
N 60 220 160 220 {lab=GND}
N 160 160 160 220 {lab=GND}
N 60 220 60 240 {lab=GND}
N -40 60 -0 60 {lab=inB}
N -200 -80 -160 -80 {lab=inA}
...
C {gnd.sym} 60 240 0 0 {name=l1 lab=GND}
C {lab_pin.sym} 200 -20 2 0 {name=p1 sig_type=std_logic lab=out}
C {lab_pin.sym} 0 -200 1 0 {name=p2 sig_type=std_logic lab=VDD}
C {lab_pin.sym} -200 -80 0 0 {name=p3 sig_type=std_logic lab=inA}
C {lab_pin.sym} -40 60 0 0 {name=p4 sig_type=std_logic lab=inB}
C {iopin.sym} -180 90 2 0 {name=p5 lab=VDD}
C {ipin.sym} -180 140 0 0 {name=p6 lab=inA}
C {ipin.sym} -180 170 0 0 {name=p7 lab=inB}
C {opin.sym} -180 220 2 0 {name=p8 lab=out}
