...
S {}
E {}
B 2 -170.5 -473.5 629.5 -73.5 {flags=graph
y1=0
y2=1.3
ypos1=0
ypos2=2
...
C {vsource.sym} -817 -228 0 0 {name=V4 value="PULSE(0 1.2 .2NS .2NS .2NS 0.01NS 10NS)" savecurrent=false}
C {gnd.sym} -817 -178 0 0 {name=l7 lab=GND}
C {vsource.sym} -767 -134 0 0 {name=V5 value="PULSE(0 1.2 .2NS .2NS .2NS 2NS 10NS)" savecurrent=false}
