...
N 0 -100 80 -100 {lab=VDD}
N 80 -80 80 -70 {lab=VDD}
N -100 -40 -60 -40 {lab=VDD}
N -60 -80 -60 -40 {lab=VDD}
N -100 -80 -60 -80 {lab=VDD}
N -100 -100 -100 -80 {lab=VDD}
N 80 -40 140 -40 {lab=VDD}
N 140 -80 140 -40 {lab=VDD}
N 80 -80 140 -80 {lab=VDD}
N 80 -100 80 -80 {lab=VDD}
N 80 20 80 40 {lab=Y}
N 80 100 80 140 {lab=#net1}
N 80 170 160 170 {lab=VDD}
N 160 170 160 220 {lab=VDD}
N 80 220 160 220 {lab=VDD}
N 80 200 80 220 {lab=VDD}
N 80 70 160 70 {lab=VDD}
N 160 70 160 170 {lab=VDD}
...
N -100 -100 0 -100 {lab=VDD}
N 80 220 80 260 {lab=VDD}
...
C {iopin.sym} 0 -160 3 0 {name=p2 lab=VDD}
C {iopin.sym} 80 260 1 0 {name=p5 lab=VSS}
