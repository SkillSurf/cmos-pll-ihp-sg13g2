...
N 340 400 660 400 {lab=VSS}
N 660 60 660 400 {lab=VSS}
...
N -300 60 -300 220 {lab=#net2}
N -160 -0 -80 -0 {lab=#net3}
N 160 -0 240 -0 {lab=#net4}
N 520 0 560 0 {lab=#net5}
N 20 60 20 220 {lab=#net6}
N 340 60 340 220 {lab=#net7}
N -480 0 -400 -0 {lab=#net5}
N -480 0 -480 160 {lab=#net5}
N -480 160 520 160 {lab=#net5}
N 520 0 520 160 {lab=#net5}
N 480 0 520 0 {lab=#net5}
N -300 -180 -300 -60 {lab=#net8}
N 20 -180 20 -60 {lab=#net9}
N 340 -180 340 -60 {lab=#net10}
N 660 -360 660 -60 {lab=VDD}
N 340 -360 660 -360 {lab=VDD}
...
N 800 -0 940 0 {lab=VOUT}
C {/foss/designs/Team2/New_inverter/inverterv1.sym} -300 0 0 0 {name=x1}
C {/foss/designs/Team2/New_inverter/inverterv1.sym} 20 0 0 0 {name=x2}
C {/foss/designs/Team2/New_inverter/inverterv1.sym} 340 0 0 0 {name=x3}
C {/foss/designs/Team2/New_inverter/inverterv1.sym} 660 0 0 0 {name=x4}
...
C {opin.sym} 940 0 0 0 {name=p4 lab=VOUT}
