...
C {vsource.sym} -470 30 0 0 {name=Vin value="dc 0 ac 0 pulse(0, 1.2, 0, 100p, 100p, 8n, 16n)" savecurrent=false}
C {gnd.sym} -470 210 0 0 {name=l2 lab=GND}
C {lab_pin.sym} -410 0 3 0 {name=p2 sig_type=std_logic lab=VB
}
C {vsource.sym} -650 30 0 0 {name=Vin1 value="dc 0 ac 0 pulse(0, 1.2, 2n, 100p, 100p, 2n, 4n)" savecurrent=false}
...
C {/foss/designs/Team2/3NAND/3NAND.sym} 30 0 0 0 {name=x1}
C {vsource.sym} -340 50 0 0 {name=Vin2 value="dc 0 ac 0 pulse(0, 1.2, 5n, 0.8n, 0.8n, 5n, 10n)" savecurrent=false}
