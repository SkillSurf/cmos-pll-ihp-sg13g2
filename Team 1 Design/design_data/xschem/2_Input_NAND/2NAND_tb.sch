...
C {/foss/designs/Team2/2NAND/2NAND.sym} 60 0 0 0 {name=x1}
C {vsource.sym} -240 70 0 0 {name=Vin value="dc 0 ac 0 pulse(0, 1.2, 0, 0.8n, 0.8n, 2n, 4n)" savecurrent=false}
C {gnd.sym} -240 220 0 0 {name=l2 lab=GND}
C {lab_pin.sym} -180 40 3 0 {name=p2 sig_type=std_logic lab=VB
}
C {vsource.sym} -420 60 0 0 {name=Vin1 value="dc 0 ac 0 pulse(0, 1.2, 2n, 100p, 100p, 2n, 4n)" savecurrent=false}
