...
C {devices/code_shown.sym} -340 -570 0 0 {name=MODEL
only_toplevel=true
...
"
place=header}
C {devices/code_shown.sym} -340 -390 0 0 {name=NGSPICE only_toplevel=true 
value="
.param temp=27
...
tclcommand="xschem raw_read $netlist_dir/tran_half_add_pex.raw tran"}
